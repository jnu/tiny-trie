...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.createFrozenJSONSync = createFrozenJSONSync;
	...
	var _FrozenTrie = __webpack_require__(6);
	 ...
	 * @return {Object}
	 */
	function createFrozenJSONSync(words) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BitString = __webpack_require__(2);

	var _BitString2 = _interopRequireDefault(_BitString);

	var _BitWriter = __webpack_require__(4);
...
/***/ function(module, exports) {
	 ...
	 */
	var BASE64_CACHE = exports.BASE64_CACHE = {
	...
	/**
	 * Char code offset, for cramming more ascii ranges into W
	 * @type {String}
	 */
	var CHAR_OFFSET = exports.CHAR_OFFSET = "a".charCodeAt(0);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FINAL_MASK = 1 << _constants.W - 1;
	...
	var Trie = (function () {
	    ...
	    _createClass(Trie, [{
	        ...
	        value: function encode() {
	            ...
	            this.apply(function (node) {
	                var value = node.letter.charCodeAt(0) - _constants.CHAR_OFFSET;
	                if (node.final) {
	                    value |= FINAL_MASK;
	                }

	                bits.write(value, _constants.W);
	            });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _RankDirectory = __webpack_require__(1);
	...
	var FrozenTrie = (function () {
	    ...
	    _createClass(FrozenTrie, [{
	        ...
	        value: function getNodeByIndex(index) {
	            ...
	            var final = this.data.get(this.letterStart + index * _constants.W, 1) === 1;
	            var letter = String.fromCharCode(this.data.get(this.letterStart + index * _constants.W + 1, _constants.W - 1) + _constants.CHAR_OFFSET);
