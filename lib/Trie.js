(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./floor_log2", "./BinaryString", "./constants"], factory);
    }
    ...
    class Trie {
        ...
        encode() {
            ...
            const charEncodingWidth = floor_log2_1.default(charTableAsArray.length) + 1;
            const pointerRange = offsetMax - offsetMin;
            const pointerEncodingWidth = floor_log2_1.default(pointerRange) + 1;
            const encodedTrie = new BinaryString_1.default();
            ...
            encodedTrie.flush();
            const headerString = new BinaryString_1.default();
